        ...
        for (k = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
          ...
          for (
            T += P + "</tr></thead><tbody>",
              ...
              A = (this._getFirstDayOfMonth(te, Z) - u + 7) % 7,
              H = Math.ceil((A + S) / 7),
              O = X ? (this.maxRows > H ? this.maxRows : H) : H,
              this.maxRows = O,
              E = this._daylightSavingAdjust(new Date(te, Z, 1 - A)),
              z = 0;
            O > z;
            z++
          ) {
            for (
              ...
              (N = g ? g.apply(t.input ? t.input[0] : null, [E]) : [!0, ""]),
                (F = E.getMonth() !== Z),
                (L = (F && !_) || !N[0] || (Q && Q > E) || (J && E > J)),
                (W +=
                  "<td class='" +
                  ...
                  ((E.getTime() === D.getTime() &&
                    Z === t.selectedMonth &&
                    t._keyEvent) ||
                  (b.getTime() === E.getTime() && b.getTime() === D.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (L
