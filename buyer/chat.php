...
a:hover{
  ...
  float: left;margin-left:20px;margin-top:10px"><img src="../images/logo/logo.png" height="50px" alt=""></a>
...
<footer>
  <p style="margin-top:12px;">Copyright &copy; <script>document.write(new Date().getFullYear());</script>, EcoBulk Shopping Platfrom</p>
</footer>
</html>
<script>
